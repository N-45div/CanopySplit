...
contract YieldDonatingStrategy is BaseStrategy {
    ...
    /// @notice Demo helper to simulate realized profit by pulling tokens from management.
    /// Requires prior ERC20 approval from management to this strategy.
    function simulateProfit(uint256 amount) external onlyManagement {
        if (amount > 0) {
